...
//            }
            ...
            <div class="panel-body">
                <div class="form-inline">
                    <div class="form-group">
                        ...
                        <input name="guru" type="text" class="form-control" id="guru"
                               value="<?php echo isset($nilaiGuru[0]->guru) ? $nilaiGuru[0]->guru : ''?>"
        ...
        <div class="pull-right">
            <div class="col-md-12">
                ...
                <a class="btn btn-danger" href="<?php echo site_url('guru/index') ?>" role="button">Batal</a>
            </div>
        </div>
    </div>
    <?php echo form_close() ?>
