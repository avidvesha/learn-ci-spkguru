...
class Kriteria extends MY_Controller
{
    ...
    public function ubah($id) {
        ...
        $data['kriteria'] = $this->MKriteria->getKriteriaId($id);
        $data['itemKriteria1'] = $this->MSubKriteria->getSubkriteriaVal(1, $id);
        $data['itemKriteria2'] = $this->MSubKriteria->getSubkriteriaVal(2, $id);
        $data['itemKriteria3'] = $this->MSubKriteria->getSubkriteriaVal(3, $id);
        $data['itemKriteria4'] = $this->MSubKriteria->getSubkriteriaVal(4, $id);
        $data['itemKriteria5'] = $this->MSubKriteria->getSubkriteriaVal(5, $id);   
        // $data['subkriteria'] = [
        //     'itemKriteria1' => $this->MSubKriteria->getSubkriteriaVal(1, $id), 
        //     'itemKriteria2' => $this->MSubKriteria->getSubkriteriaVal(2, $id), 
        //     'itemKriteria3' => $this->MSubKriteria->getSubkriteriaVal(3, $id), 
        //     'itemKriteria4' => $this->MSubKriteria->getSubkriteriaVal(4, $id), 
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->MKriteria->update();
            $this->MSubKriteria->update();
